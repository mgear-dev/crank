...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.preHold_spinBox, 1, 1, 1, 1)
        ...
        self.addFrameSolo_pushButton = QtWidgets.QPushButton(self.groupBox_2)
        self.addFrameSolo_pushButton.setObjectName("addFrameSolo_pushButton")
        self.verticalLayout.addWidget(self.addFrameSolo_pushButton)
        ...
        self.delFrame_pushButton = QtWidgets.QPushButton(self.groupBox_2)
        self.delFrame_pushButton.setObjectName("delFrame_pushButton")
        self.verticalLayout.addWidget(self.delFrame_pushButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.addFrameSolo_pushButton.setText(QtWidgets.QApplication.translate("Form", "Add Sculpt Frame Solo", None, -1))
        self.editFrame_pushButton.setText(QtWidgets.QApplication.translate("Form", "Edit Selected Sculpt Frame", None, -1))
        self.delFrame_pushButton.setText(QtWidgets.QApplication.translate("Form", "Del Selected Sculpt Frames", None, -1))
